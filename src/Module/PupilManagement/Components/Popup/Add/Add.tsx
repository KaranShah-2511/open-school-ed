...
function Add(props: AddProps) {
  ...
  const onSubmit = async (values, { setSubmitting, setFieldError }) => {
    ...
    await pupilService.csvBySchoolId(user?.UserDetialId, values.csv, progressEvent)
      .then((res) => {
        setSuccess('Pupil upload successfully.');
          ...
          <div className="modal-inner">
            ...
            <div className="app-modal-content">
              <ul>
                ...
                <li>
                  <Link to={'/pupil-management/add'} state={{ returnTo: '/pupil-management' }} title="Add Manually">
      ...
      </Modal>
      {
        (csvUploadShow)
          ? <CsvUpload
            error={error}
            progress={progress}
            sampleFileLink='sample-files/sample-pupil.csv'
            onSubmit={onSubmit}
